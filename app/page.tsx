    ...
    <div className="landing-page">
      ...
      <section className="mechanics-section" aria-labelledby="how-title">
        <header className="section-heading">
          ...
          <p>Every move is clear before you preview it in demo mode or approve it live in your wallet.</p>
        </header>
      ...
      <section className="daily-section" aria-labelledby="daily-title">
        ...
        <div className="daily-card">
          ...
          <strong id={dailyPreviewCountId} aria-label={`${stats.claimed} of 36 patches claimed this UTC round`}>
            {stats.claimed}
      ...
      <section className="network-explainer" aria-labelledby="network-title">
        <header className="section-heading compact">
          ...
          <h2 id="network-title" tabIndex={-1}>Same arena rules.<br />Use the wallet you already use.</h2>
        </header>
